...
export function Navbar() {  
    ...
    return (  
        <div className="w-full flex flex-row justify-between bg-[#f9f9f9] py-6 px-28 items-center">  
            ...
            <div className="ml-20">   
                ...
                ></i>  
                <ul className={` sm:flex-col sm:rounded-xl sm:absolute sm:right-52 sm:bg-[#c7c3c3] sm:text-white sm:px-4 sm:py-4 xl:flex xl:flex-row xl:relative sm: xl:right-0 xl:bg-[#f9f9f9] xl:text-black xl:px-0 xl:py-0 gap-10 cursor-pointer transition-colors ${isMenuOpen ? 'flex' : 'hidden'}`}>  
